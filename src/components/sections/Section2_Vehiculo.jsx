...
import { validarSeccion2 } from '../../lib/validation'
    ...
    <div className="section-enter" style={{ padding: '0 16px 40px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div>
          ...
          {errores.marca && <p className="s-error">⚠ {errores.marca}</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Corolla, Tucson, Mazda 3…"
            className={`s-input ${errores.modelo ? 's-input-err' : ''}`}
          />
          {errores.modelo && <p className="s-error">⚠ {errores.modelo}</p>}
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          <div>
            ...
            {errores.anio && <p className="s-error">⚠ {errores.anio}</p>}
          </div>
          ...
          <div>
            ...
            />
            {errores.patente && <p className="s-error">⚠ {errores.patente}</p>}
          </div>
        </div>
